            ...
            { car !== null &&
                ...
                <PanelDisabled/>
                            ...
                            <div className='details-container-right'>
                                <div className='details-container-right-inner'>
                                    <div className='car-image-container'>
                                        <img src={car.image} className='car-image' alt="" />
                                    </div>
                                    ...
                                    <div className='car-details-container'>
                                        <div className='car-detail-icons'>
                                            <div className='car-detail-icon'>
                                                <img src={IconPeople} className='car-icon' alt="" />
                                            </div>
                                        ...
                                        <div className='car-detail-icons'>
                                            <div className='car-detail-icon'>
                                                <img src={IconGear} className='car-icon' alt="" />
                                            </div>
                                            <div className='car-book-text'>
                                                {car.transmission}
                                            </div>
                                        ...
                                        <div className='car-detail-icons'>
                                            <div className='car-detail-icon'>
                                                <img src={IconCalendar} className='car-icon' alt="" />
                                            </div>
                                            <div className='car-book-text'>
                                                Tahun {car.year}
                                            </div>
                                    ...
                                    <button className='btn button-right-details-container' disabled={ item === car.id } onClick={ () => dispatch(cartSlice.actions.addItem({ id: car.id }) ) }>
                                        <div type="submit" className='button-right-details'>
                                            { item === car.id ? 'Lanjutkan Pembayaran' : 'Pilih mobil' }
                                        </div>
                                    </button>
                                </div>
                            </div>
                    ...
                    <div className='button-center-container-outer'>
                        <button className='btn button-center-container' disabled={ item === car.id } onClick={ () => dispatch(cartSlice.actions.addItem({ id: car.id }) ) }>
